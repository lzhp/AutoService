...
public class AutoService {
  ...
  public String toString() {
    return "AutoService [serviceName=" + serviceName + ",queueSize=" + queueSize
        + ", accessorIdleSeconds=" + accessorIdleSeconds + ", processorIdleSeconds="
        + processorIdleSeconds + ", accessorThreadCounts=" + accessorThreadCounts
        + ", processorThreadCounts=" + processorThreadCounts + ", accessorParams=" + accessorParams
        + ", processorParams=" + processorParams + ", accessorName=" + accessorName
